 ...
 * <p/>
 * 类工具
 * (鸣谢fanlinlong,http://www.cnblogs.com/fanlinglong/p/6710134.html)
 */
public class ClassUtils {
    ...
    public static void main(String[] args) {
        System.out.println(getAllAdaptor("com.yugioh.netty.server.business"));
    }

    /**
     * 判断是否属于该接口的实现类
     *
     * @param clazz  本次待判断的实现类
     * @param iClazz 接口类
     * @return
     */
    public static boolean isImplements(Class<?> clazz, Class<?> iClazz) {
        return clazz != null && iClazz != null && iClazz.isAssignableFrom(clazz) && !clazz.equals(iClazz);
    }
